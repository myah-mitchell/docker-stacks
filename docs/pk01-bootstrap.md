...
Semaphore's static SSH key can be replaced with a dedicated service principal on a short-lived, auto-renewed step-ca certificate. See [step 13 of Semaphore setup](semaphore-setup.md#13-replace-this-key-once-step-ca-is-live).
