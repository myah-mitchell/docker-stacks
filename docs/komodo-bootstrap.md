...
Folding km01's own UI behind Traefik and Authentik needs ci01, id01, and pk01 all live first, plus [traefik-agent](traefik-agent-setup.md) proven on a less critical host. km01 gets that retrofit last, not first.
